...
const ApplicantsTable = () => {
    const initialApplicants = useSelector((store) => store.application.applicants);
    ...
    useEffect(() => {
        const fetchApplicants = async () => {
            if (!jobId) {
                ...
                return; // Exit if jobId is invalid
            }

            try {
                axios.defaults.withCredentials = true;
                const url = `${APPLICATION_API_END_POINT}/${jobId}/applicants`;
    ...
    // Memoized filteredApplications: ensures hooks run consistently
